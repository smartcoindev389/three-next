...
import fragShader from "./shaders/fragment.js";
...
const Model = React.forwardRef<Mesh, Props>(({ src }, ref) => {
      ...
      const timeline = gsap
        ...
        .add(
          gsap.to(uniforms.uRandom, {
            value: 0.3,  // Much lower for clearer photo
            duration: 1,
          }),
          "showStart",
        )
        .add(
          gsap.fromTo(
            ...
            {
              value: 1,  // Reduced for flatter image
            },
          ),
          "showStart",
        )
        .add(
          gsap.fromTo(
            ...
            { value: 2.5 },  // Larger particles for better clarity
          ),
          "showStart",
        );
  ...
  const uniformsData = useMemo(
    () => ({
      ...
      uRandom: { value: 0.5 },  // Reduced for clearer photo
      uDepth: { value: 1 },     // Reduced depth for flatter, clearer image
      uSize: { value: 2.5 },    // Increased particle size for better clarity
      uTouch: { value: null },
    }),
